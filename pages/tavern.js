	...
	return (
		<section className={'mt-12'}>
			...
			<div className={'max-w-screen-lg w-full mx-auto'}>
				...
				<h>不过这需要你的完全授权，请把私钥和招募的小队数量输入到下方。请放心，私钥完全在本地存储，不会上传到服务器的。</h>
				<h>批量招募是按照小队为单位进行的，每个小队11人，请输入纯数字。例如你输入3，那么你将拥有3个小队共33人</h>
				<input type="text" name="the_key" placeholder="此处粘贴私钥" style={{width:700}}></input>
				<input type="text" name="the_number" placeholder="招募数量" style={{width:100}}></input>
				<div>
				<button onclick="copyText()" type="button" style={{outline:5}}>点我进行批量招募!</button>
